$$
\begin{array} { r l r } & { } & { \frac { J _ { 1 } ( a ^ { * } \hat { k } _ { n } ) } { J _ { 0 } ( \hat { k } _ { n } ) } = \frac { 1 } { \sqrt { a ^ { * } } } \frac { \cos \Big [ a ^ { * } \hat { k } _ { n } - \frac { 3 } { 4 } \pi \Big ] \perp { 0 } ( n a ^ { * } ) ^ { - 3 / 2 } } { \cos \Big [ \Big ( n \perp \frac { 1 } { 4 } \Big ) \pi - \frac { 1 } { 4 } \pi \Big ] \perp { 0 } \Big ( \frac { 1 } { n } \Big ) } } \\ & { } & { = \frac { 1 } { \sqrt { a ^ { * } } } \frac { \cos \Big [ a ^ { * } \hat { k } _ { n } - \frac { 3 } { 4 } \pi \Big ] \perp { 0 } [ ( n a ^ { * } ) ^ { - 3 / 2 } ] } { ( - 1 ) ^ { n } \perp { 0 } \Big ( \frac { 1 } { n } \Big ) } } \end{array}
$$
...
$$
\biggl [ \frac { J _ { 1 } ( a ^ { * } \bigl \vert _ { n } ) } { J _ { 0 } ( \bigl \vert \hat { k } _ { n } ) } \biggr ] ^ { 2 } { \leq } \frac { 1 } { a ^ { * } } \frac { 1 \mathbin { \perp } \mathsf { O } [ ( \mathsf { n a } ^ { * } ) ^ { - 3 / 2 } ] } { 1 \mathbin { \perp } \mathsf { O } \left( \frac { 1 } { n } \right) } \ [ \mathbf { A } \mathbf { - B } \mathbf { - } 7 ]
$$

$$
N \equiv \frac { 4 } { \pi ^ { 2 } R a ^ { * } }\tag{[A-B-11]}
$$

Since $I ^ { * } \mathrm { { _ { t o t a l } } } < 1 , R$ will always be $R < 0 . 1$ and therefore condition [A-B-11] is sufficient.
...
2. H. 'H. Úhlig, Proceedings 2nd Inter. Congress on Metallic Corrosion, NACE, 1966, p. 1.

3. I. L. Rosenfeld and I. S. Danilov, Corrosion Sci., 7, 129 (1967).

$$
\begin{array} { r l } & { \cdot \frac { 1 } { \left\{ \coth \ ( \hat { \textbf { k } } _ { n } \pi c ^ { * } ) \ \_ \perp \ k ^ { * } \left[ \left( \textbf {  { n } } _ { \perp } \frac { 1 } { 4 } \right) \pi \ _ { \perp } \ \bigcirc \left( \displaystyle \frac { 1 } { n } \right) \right] \right\} \left[ \left( \textbf {  { n } } _ { \perp } \frac { 1 } { 4 } \right) \pi \ _ { \perp } \ O \left( \frac { 1 } { n } \right) \right] } } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \\ & { \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad \quad } \end{array}
$$

Therefore

$$
\begin{array} { r } { | R _ { N } | = R _ { N } \le \frac { 4 ( 1 \perp { 0 } [ ( N a ^ { \ast } ) ^ { - 3 / 2 } ] ) } { a ^ { \ast } \pi ^ { 2 } } \displaystyle \int _ { N } ^ { \infty } \frac { d x } { x ^ { 2 } } } \\ { = \frac { 4 ( 1 \perp { 0 } [ ( N a ^ { \ast } ) ^ { - 3 / 2 } ] ) } { N a ^ { \ast } \pi ^ { 2 } } } \end{array}\tag{[A-B-9]}
$$

To obtain a chosen accuracy of R the number of terms N has to fulfill

$$
N > > \frac { 1 } { a ^ { * } }\tag{[A-B-10]}
$$
...
8. E. Kennard and J. T. Waber, ibid., 117, 880 (1970).
...
<table><tr><td rowspan="2">Desig- nation</td><td colspan="7">Composition (%)</td></tr><tr><td>Cr</td><td>Mo</td><td>Ni</td><td>Si</td><td>Mn</td><td>C</td><td>N</td></tr><tr><td>4354A</td><td>17.61</td><td>0.035</td><td>0.091</td><td>0.22</td><td>0.55</td><td>0.028</td><td>0.032</td></tr><tr><td>4354B</td><td>NA(a)</td><td>0.96</td><td>NA</td><td>NA</td><td>NA</td><td>NA</td><td>NA</td></tr><tr><td>4354C</td><td>NA</td><td>2.06</td><td>NA</td><td>NA</td><td>NA</td><td>NA</td><td>NA</td></tr><tr><td>4354D</td><td>NA</td><td>3.51 4.67</td><td>NA NA</td><td>NA NA</td><td>NA NA</td><td>NA 0.031</td><td>NA 0.033</td></tr><tr><td>4354E</td><td>17.31 18.45</td><td></td><td>0.11</td><td>0.13</td><td>1</td><td>0.034</td><td>0.045</td></tr><tr><td>4073A</td><td></td><td>1.97</td><td></td><td></td><td></td><td></td><td></td></tr></table>

(a) NA = not analyzed, but assumed to be in the range of the series.

![](images/8d59613e68dc0dfc1836849330c39116197ff6d7867c6d5ec293758b4a6588e4.jpg)  
Fig. 1. Polarization curve obtained on scanning a masked electrode of alloy 4354D (3.5% Mo at 200 mV/hr in nitrogen-saturated 1.0M NaCl at 70°C).
...
It is known that this heat-treatment also sensitizes these steels to intergranular corrosion (6). It is thought that the intergranular corrosion is the result of precipitation of carbides and nitrides rich in chromium and molybdenum, causing depletion of the adjacent matrix (7). Thus, it is to be expected that steels heat-treated so as to be sensitive to intergranular corrosion would be more susceptible to pitting corrosion than would properly annealed steels, as was recently reported for 26% Cr ferritic alloys (8). A similar effect has been observed for austenitic stainless steels exposed in ferric chloride (9).

![](images/955f565d72a8265c693fc823f82a8b5c228b04e841045e26ab2fd328be44b610.jpg)  
Fig. 3. Structure (islands of chi in a ferrite matrix) of the 18% Cr-5% Mo alloy (4354E) annealed 1 hr at 815°C and waterquenched; 500×.
...
Table Ill. Effect of heat-treatment on pitting potentials in N2-saturated 1M NaCl at 25°C
<table><tr><td rowspan="2">Heat</td><td rowspan="2">% Mo</td><td colspan="2">Pitting potential, V (SCE)</td></tr><tr><td>815°C, WQ</td><td>980°C, WQ</td></tr><tr><td>4354C</td><td>2</td><td>0.25</td><td>-0.01</td></tr><tr><td>4354D</td><td>3.5</td><td>0.26 0.31</td><td>0.04</td></tr><tr><td></td><td></td><td>0.26</td><td></td></tr><tr><td>4354E</td><td>4.7</td><td>0.29 0.24</td><td>-0.01</td></tr></table>

Table IV. Effect of heat-treatment on the pitting potential of Ti-stabilized 18% Cr-2% Mo ferritic stainless steels in nitrogen-saturated 1M NaCl at a scanning rate of 2000 mV/hr at 45°℃
<table><tr><td rowspan="2">(weight)</td><td rowspan="2">Ti content</td><td colspan="2">Pitting potential, V (SCE), after water quenching from the indicated temperatures</td></tr><tr><td>815°C</td><td>925°C 1035°C</td></tr><tr><td>4073A</td><td></td><td></td><td></td><td>0.53</td></tr><tr><td rowspan="3"></td><td>0.47</td><td>0.27 0.35</td><td>0.30</td><td>0.59</td></tr><tr><td></td><td>0.29</td><td></td><td>0.50</td></tr><tr><td></td><td></td><td></td><td></td></tr></table>

![](images/db78da07a46206ac67926920635da368037c2e07de4ae1f1879b0e67c15fc842.jpg)  
Fig. 4. Pitting potentials obtained from potentiodynamic polarization scans at 200 mV/hr in nitrogen-saturated 1.0M NoBr.

that, as expected, heat-treatment at temperatures up to 1035°C had no deleterious effect on pitting potential. In fact, after treatment at 1035°C, the pitting potential was more noble than it was after the normal annèal at 815°C. It was also noted that the titaniumcontaining alloy had a more noble pitting potential than the titanium-free alloy under the same conditions. Earlier work with this alloy at 25°C also indicated that titanium was beneficial to pitting resistance (11).

Pitting potentials measured in 1M NaBr varied with composition in the same way as in 1M NaCl (Fig. 4). Pitting potentials were more noble in NaBr, especially at higher temperatures. The beneficial effect of molybdenum additions on pitting potentials of this series of steels in NaBr is just as clearly defined as it is in NaCl. The pitting potentials measured in 1M NaCl and in 1M NaBr at 25°C indicate that all the steels studied should be subject to pitting in 0.33M FeCl3, 0.5M CuCl2, and 0.33M FeBr3 solutions. Exposure tests did indeed show pitting of all the test steels in these solutions at 25°C (Table V). In all cases, the rate of attack decreased with increasing molybdenum content up to 3.5%. The behavior of the 4.7% Mo steel was erratic in these solutions.
...
<table><tr><td rowspan="2">Medium</td><td colspan="5">Corrosion rate (mdd) of indicated alloys</td></tr><tr><td>4354A 0% Mo</td><td>4354B 1% Mo</td><td>4354C 2% Mo</td><td>4354D 3.5% Mo</td><td>4354E 5% Mo</td></tr><tr><td>0.33M FeCls+ 0.1N HCl</td><td>7200</td><td>7700</td><td>5300</td><td>670</td><td>220</td></tr><tr><td>0.33M FeBr3+ 0.1N HBr</td><td>920</td><td>230</td><td>120</td><td>75</td><td>140</td></tr><tr><td>0.5M CuCl₂+ 0.1N HCl</td><td>740</td><td>610</td><td>650</td><td>330</td><td>560</td></tr></table>

Table VI. Results of 30 day complete immersion tests in oxygen-saturated aqueous solutions at 90°C
<table><tr><td rowspan="2">Solution</td><td colspan="5">Corrosion rate (mdd) of the indicated alloys</td></tr><tr><td>4354A 0% Mo</td><td>4354B 1% Mo</td><td>4354C 2% Mo</td><td>4354D 3.5% Mo</td><td>4354E 5% Mo</td></tr><tr><td>3% NaCl 125 ppm Cl-, 60 ppm Cu++</td><td>63 95</td><td>nil 0.4</td><td>0.4 0.4</td><td>nil nil</td><td>0.3 0.3</td></tr></table>
...
6. A. P. Bond and 'E. A. Liziovs, This Journal, 116, 1305(1969).

7. A. P. Bond, Trans. AIME, 245, 2127 (1969).

8. C. R. Rarey and A. H. Áronson, Corrosion, 28, 255 (1972).
